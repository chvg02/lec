        ...
        <section className="relative">
            <div className=" mx-auto px-4 py-20 sm:py-24 md:py-32 lg:py-50">
                <div className="relative min-h-[480px] flex flex-col gap-8 z-10 items-center rounded-2xl overflow-hidden justify-center text-center bg-cover bg-center bg-no-repeat p-6" data-alt="Abstract blue and purple digital art representing technology and learning background-image: linear-gradient(rgba(17, 24, 39, 0.4) 0%, rgba(17, 24, 39, 0.7) 100%)">
                    ...
                    <Button  className="relative z-20 rounded-full bg-[#0088b7] hover:bg-[#0077a3]/90 transition-colors">{Textbutom}</Button>
                    </Link>
                </div>
