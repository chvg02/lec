                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li className="flex items-start gap-2">
                                ...
                                <span className="break-words">Av. Costa e Silva, s/n - Pioneiros, Campo Grande - MS, 79070-900</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <Mail size={20} className="shrink-0" ></Mail>
                                <a className="break-all hover:text-white" href="mailto:contato.lec@ufms.br">contato.lec@ufms.br</a>
                            </li>
                        </ul>
                    </div>
                </div>
