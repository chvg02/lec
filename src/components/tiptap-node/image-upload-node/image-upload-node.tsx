...
interface ImageUploadDragAreaProps {
  ...
  /**
   * Optional child elements to render inside the drag área
   * @optional
   * @default undefined
   */
...
/**
 * A component that creates a drag-and-drop área for image uploads
 */
const ImageUploadDragArea: React.FC<ImageUploadDragAreaProps> = ({
  ...
  return (
    <div
      className={`tiptap-image-upload-drag-área ${isDragActive ? "drag-active" : ""} ${isDragOver ? "drag-over" : ""}`}
